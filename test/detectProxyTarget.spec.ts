...
import { detectProxyTarget } from '../src/detectProxyTarget'
...
describe('detectProxyTarget', () => {
  ...
  it('detects EIP-1967 direct proxies', async () => {
    ...
    ).to.equal('0x4bd844F72A8edD323056130A86FC624D0dbcF5b0')
  })
  ...
  it('detects EIP-1967 beacon proxies', async () => {
    ...
    ).to.equal('0xE5C048792DCf2e4a56000C8b6a47F21dF22752D1')
  })
  ...
  it('detects EIP-1967 beacon variant proxies', async () => {
    ...
    ).to.equal('0xfE8e4f1234c87418986fEFaE0c0e2642280ace82')
  })
  ...
  it('detects OpenZeppelin proxies', async () => {
    ...
    ).to.equal('0xE3F3c590e044969294B1730AD8647692FAF0f604')
  })
  ...
  it('detects EIP-897 delegate proxies', async () => {
    ...
    ).to.equal('0x34CfAC646f301356fAa8B21e94227e3583Fe3F5F')
  })
